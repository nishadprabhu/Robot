...
void waitForStart() {
    ...
    LCD.Clear();
    while(cds2.Value() > START_LIGHT_ON);
}
/** getLightColor
...
void dropOff() {
    ...
    move_backwards_timed(10, 3, 2);
    move_forward(10, 1);
    check_y_plus(Location::MID_SWITCH_Y);
    turn_left(20, 90);
    faceDegree(180);
...
void goHome() {
    turn_right(20, 45);
    faceDegree(0);
    check_x_plus(Location::TOP_MAIN_RAMP_X);
    turn_right(20, 90);
    faceDegree(270);
